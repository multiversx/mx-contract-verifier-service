...
export class ContractVerifier {
  ...
  @ApiProperty({ description: 'Source code of contract', type: ContractVerifierSource })
  source?: ContractVerifierSource;

  @ApiProperty({ description: 'Verifier process status', enum: ContractVerifierStatus })
